...
project = "rom-tools-and-workflows-demos"
...
htmlhelp_basename = "romtoolsandworkflowsdemosdoc"
...
latex_documents = [
        ("index", "rom-tools-and-workflows.tex", "rom-tools-and-workflows Doc", "bla bla", "manual"),
]
